...
namespace HelperTools.IO
{
	...
	{
		public static readonly FileNameNormalization Instance = new FileNameNormalization();
		...
		{
			return !string.IsNullOrWhiteSpace(objectToValidate) && Regex.IsMatch(objectToValidate, ValidationPattern(), Options);
		}
		...
		public override string Sanitize(string value)
		{
			...
			if (!string.IsNullOrEmpty(value) && !Validate(value))
			{
				...
				Dictionary<char, char> replaceChars =
