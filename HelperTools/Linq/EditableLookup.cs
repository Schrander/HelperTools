...
namespace HelperTools.Linq
{
	...
	public sealed partial class EditableLookup<TKey, TElement> : ILookup<TKey, TElement>
	{
		...
		public bool Contains(TKey key)
		{
			...
			return groups.TryGetValue(key, out @group) && @group.Count > 0;
		}
		/// <summary>
		...
		{
			LookupGrouping group;
			return groups.TryGetValue(key, out @group) && @group.Contains(value);
		}
		/// <summary>
		...
		public IEnumerable<TElement> this[TKey key]
		{
			...
			{
				LookupGrouping group;
				return groups.TryGetValue(key, out @group) ? @group : Empty;
			}
		}
		/// <summary>
