...
namespace HelperTools.Text
{
	public static class TextFormatting
	{
		...
		/// </summary>
		/// <param name="value">de aan te passen tekst</param>
		/// <returns>de aangepaste tekst</returns>
		public static string RemoveDiacritics(string value, bool isGerman)
		{
		...
		/// <param name="s">The string</param>
		/// <returns></returns>
		public static string ToPascalCaseLossLess(this string s)
		{
			if (string.IsNullOrEmpty(s))
				return null;
			s = s.Sanitize();
		...
		/// <param name="s">The string</param>
		/// <returns></returns>
		public static string ToPascalCaseWordTrimmed(this string s)
		{
		...
		/// <param name="s">The string</param>
		/// <returns></returns>
		public static string ToCamelCaseWordTrimmed(this string s)
		{
		...
		public static string Formatting(this string value, CaseFormatType? formatType)
		{
			...
			{
				case CaseFormatType.UpperCase:
					return value.ToUpper();

				case CaseFormatType.LowerCase:
					return value.ToLower();

				case CaseFormatType.PascalCase:
					return value.ToPascalCase();

				case CaseFormatType.CamelCase:
					return value.ToCamelCase();

				case CaseFormatType.TitleCase:
					return value.ToTitleCase();

				case CaseFormatType.FirstLetterLowerCase:
					return value.FirstLetterToLower();

				case CaseFormatType.FirstLetterUpperCase:
